...
const updates = {
  ...
  'legal-status': {
    finding: 'La autorización de arraigo extraordinario dura un año y permite residir y trabajar. Solicitudes y expedientes tramitados no equivalen a concesiones; sigue pendiente un balance de resoluciones por resultado.',
