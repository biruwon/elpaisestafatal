...
export type PublicEvidenceFamily = { familyId: string; familyLabel: string; label: string; direction: 'supports' | 'qualifies' | 'contradicts' | 'neutral'; status?: EvidenceStatus; dataKind?: 'observed' | 'projected' | 'snapshot' | 'context'; dimensions?: EvidenceDimensions; evidenceIds: string[]; sourceIds: string[]; finding?: string; limitation?: string; period?: string; data?: string[]; missingDimensions?: string[]; criteria?: PublicEvidenceCriterion[] };
