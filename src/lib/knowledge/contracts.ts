...
export type AnswerPlan = {
  ...
  evidenceSummary?: {
    ...
    families: Array<{ familyId?: string; familyLabel?: string; label: string; direction: 'supports' | 'qualifies' | 'contradicts' | 'neutral'; status?: 'available' | 'partial' | 'missing'; dimensions?: { subject?: string; population?: string; period?: string; geography?: string; denominator?: string; unit?: string; causalRequirement?: string }; evidenceIds: string[]; sourceIds?: string[]; finding?: string; limitation?: string; period?: string; data?: string[]; missingDimensions?: string[]; criteria?: Array<{ id: string; label: string; finding: string; status?: 'available' | 'partial' | 'missing'; dimensions?: { subject?: string; population?: string; period?: string; geography?: string; denominator?: string; unit?: string; causalRequirement?: string }; evidenceIds?: string[]; sourceIds?: string[]; data?: string[]; missingDimensions?: string[] }> }>;
    missingDimensions?: string[];
