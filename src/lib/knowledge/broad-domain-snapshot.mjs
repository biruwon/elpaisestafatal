...
const packets = [
  ...
  },
  {
    ...
    limitations: ['Ahora hay cifras oficiales observadas y presupuestadas, además de una serie anual proyectada de AIReF con ingresos, gastos, saldo y transferencias para 2020–2070. La cuenta consolidada y las estadísticas agregadas no ofrecen todavía un balance anual observado que impute cada ingreso y gasto exclusivamente a pensiones; el criterio de “arruinando” es operativo para esta comprobación, no una definición legal ni una prueba de quiebra inmediata. Por eso la presión demográfica, el escenario proyectado y la quiebra pública siguen siendo afirmaciones diferentes.'],
    sources: [
...
const answerPlanForPacket = (packet, { now = Date.now(), observations = [] } = {}) => {
  ...
  return {
    ...
    knowledgeVersion: 'broad-domain-snapshot-2-pension-finance-series',
  };
};
