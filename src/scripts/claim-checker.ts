...
type EvidenceCriterion = { id: string; label: string; finding?: string; status?: EvidenceStatus; dimensions?: EvidenceDimensions; evidenceIds?: string[]; sourceIds?: string[]; data?: string[]; missingDimensions?: string[] };
type EvidenceFamily = { familyId?: string; familyLabel?: string; label: string; direction: string; status?: EvidenceStatus; dimensions?: EvidenceDimensions; evidenceIds: string[]; sourceIds?: string[]; finding?: string; limitation?: string; period?: string; data?: string[]; missingDimensions?: string[]; criteria?: EvidenceCriterion[] };
type CheckResponse =
