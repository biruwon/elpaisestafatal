...
type EvidenceCriterion = { id: string; label: string; finding?: string; status?: EvidenceStatus; dataKind?: EvidenceDataKind; dimensions?: EvidenceDimensions; evidenceIds?: string[]; sourceIds?: string[]; data?: string[]; missingDimensions?: string[] };
