...
const requiredPageMarkers = [
  ...
  ['claim-catalog-more', 'progressive catalogue control'],
...
for (const snippet of ['activeTopic', 'aria-pressed', 'card.hidden', 'initialLimit', 'expanded', 'No hay una ficha']) if (snippet !== 'No hay una ficha' && !source.includes(snippet)) failures.push(`catalogue script is missing ${snippet}`);
...
if (!page.includes('Ver más afirmaciones')) failures.push('catalogue is missing the progressive disclosure label');
