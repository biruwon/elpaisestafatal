...
const cases = [
  ...
  { text: 'Sin inmigración el sistema de pensiones quebraría inmediatamente.', status: 'complete', slug: 'sin-inmigracion-el-sistema-de-pensiones-quebraria-inmediatamente' },
...
if (process.env.SMOKE_WAREHOUSE === '1') {
  ...
  try {
    const result = await resolve('España es más desigual que la Unión Europea');
