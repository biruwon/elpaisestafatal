...
const required = ['renderResult', 'Respuesta con fuentes', 'Evidencia limitada', 'data-copy-answer', 'claim-sources', 'claim-key-fact', 'result-redesigned', 'result-visual', 'result-chart', 'result-data-table', 'result-evidence', 'result-limit', 'result-details', 'publicMetricLabel', 'prefers-reduced-motion'];
