...
const required = ['renderResult', 'Comprobación revisada', 'Orientación provisional', 'data-copy-answer', 'claim-sources', 'claim-facts', 'claim-key-fact', 'classList.toggle', 'h2', 'prefers-reduced-motion'];
