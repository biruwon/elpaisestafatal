...
const required = ['renderResult', 'Respuesta con fuentes', 'Evidencia limitada', 'data-copy-answer', 'claim-sources', 'result-redesigned', 'result-scorecard', 'scorecard-grid', 'scorecard-values', 'scorecard-methodology', 'result-visual', 'result-chart', 'result-data-table', 'result-evidence', 'result-limit', 'result-details', 'publicMetricLabel', 'stateConclusion', 'prefers-reduced-motion'];
