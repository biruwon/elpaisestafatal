...
const required = ['const render =', 'Fuentes verificadas', 'sin fuentes verificadas', 'Qué no demuestra', 'data-copy-answer', 'data-share-result', 'data-new-check', 'claim-result-sources', '<table>', 'catalogueEntry'];
