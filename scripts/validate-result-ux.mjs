...
const required = ['renderResult', 'Respaldada por fuentes', 'Evidencia limitada', 'data-copy-answer', 'claim-sources', 'claim-facts', 'claim-key-fact', 'classList.toggle', 'h2', 'prefers-reduced-motion'];
