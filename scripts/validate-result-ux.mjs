...
const required = ['renderResult', 'Respuesta con fuentes', 'Evidencia limitada', 'data-copy-answer', 'claim-sources', 'claim-share-sources', 'Fuentes principales', 'result-redesigned', 'result-scorecard', 'scorecard-grid', 'scorecard-values', 'scorecard-methodology', 'result-visual', 'result-chart', 'result-horizontal-visual', 'result-bar-zero', 'result-data-table', 'result-evidence', 'result-limit', 'result-details', 'claim-reply', 'claim-reply-text', 'item.keyFact || stateConclusion', 'publicMetricLabel', 'stateConclusion', 'prefers-reduced-motion', 'loadingStagesFor', 'Comprobando la regularización', 'Buscando indicadores de servicios públicos', 'Revisando prestaciones', 'Aún no hay una respuesta final', 'Esperando respuesta final', 'Respuesta provisional', 'Respuesta final', 'la revisión de fuentes ha terminado', "renderResult(response.preview, 'provisional')", "initialPreview ? 'final'", 'evidenceGroupsFor', 'renderMissingList', 'data-evidence-groups', 'data-family-id', 'Fuentes de esta familia', 'Qué queda pendiente en esta familia', 'result-methodology', 'familia se evalúa con sus propias medidas', 'sin una medición compatible localizada', 'Datos compatibles y límites', '<ul>', 'statusLabel', 'evidence-family-limitation'];
