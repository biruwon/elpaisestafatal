...
let roadmap = '';
try { roadmap = await readFile(new URL('../roadmap.md', import.meta.url), 'utf8'); } catch { /* optional documentation */ }
const failures = [];
...
if (roadmap) requireText(roadmap, 'knowledge:triage', 'roadmap documentation for the one-command triage workflow');
