const knownSeeds = [
  ...
  ['espana-mas-deuda-publica-ue', 'comparison', 'España tiene más deuda pública que la Unión Europea'],
  ['espana-menos-fecundidad-ue', 'comparison', 'España tiene menos hijos por mujer que la Unión Europea'],
...
export const acceptanceCases = [
  ...
  {
    id: 'acceptance-named-government-country-worse',
    input: 'Pedro Sánchez está destruyendo España',
    expected: { answerMode: 'scorecard', resultState: 'answered', reviewed: false, noOverallVerdict: true },
  },
  {
  ...
  {
    id: 'acceptance-named-government-country-better',
    input: 'Sánchez está mejorando España',
    expected: { answerMode: 'scorecard', resultState: 'answered', reviewed: false, noOverallVerdict: true },
  },
  {
