...
const html = renderReviewDashboard({
  ...
  sourceWork: [{ rank: 1, clusterId: 'cluster-2', canonicalText: 'Pregunta sin fuente', queryCount: 5, count7d: 3, rankScore: 12, harmScore: 2, urgencyScore: 1, evidenceReadiness: 0, requiredDimensions: ['geography', 'period'], auditClass: 'true_research_gap', action: 'find_source', nextAction: 'find_source', reason: 'No direct source' }],
});
