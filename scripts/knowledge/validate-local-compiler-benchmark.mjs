...
const required = ['compilerSchema', 'normalizeCompilerOutput', 'deterministicFallbackCompiler', 'createLocalInferenceProvider', 'inference.listModels', 'inference.chat', 'safetyPreserved', 'recommendedModel', 'minimumQuality', 'maxWarmP95Ms', 'p95Ms <= maxWarmP95Ms', 'timeoutMs', 'const endpointUrl = new URL(endpoint)'];
