...
const required = ['compilerSchema', 'normalizeCompilerOutput', 'deterministicFallbackCompiler', 'createLocalInferenceProvider', 'inference.listModels', 'inference.chat', 'safetyPreserved', 'recommendedModel', 'minimumQuality', 'timeoutMs'];
