...
const required = ['compilerSchema', 'normalizeCompilerOutput', 'deterministicFallbackCompiler', 'endpointUrl.hostname', 'localHosts', 'safetyPreserved', 'recommendedModel', 'minimumQuality', 'AbortSignal.timeout'];
