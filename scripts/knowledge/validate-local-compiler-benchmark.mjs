...
const required = ['compilerSchema', 'normalizeCompilerOutput', 'reconcileCompilerSafety', 'deterministicFallbackCompiler', 'createLocalInferenceProvider', 'inference.listModels', 'inference.chat', 'safetyPreserved', 'recommendedModel', 'minimumQuality', 'maxWarmP95Ms', 'caseLimit', 'complete: caseLimit === cases.length', 'unavailableModels', 'p95Ms <= maxWarmP95Ms', 'timeoutMs', 'const endpointUrl = new URL(endpoint)'];
