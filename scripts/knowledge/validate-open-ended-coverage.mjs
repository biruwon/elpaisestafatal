...
assert(demographicPensionReply.includes('29,5') && demographicPensionReply.includes('personas de 65 años o más por cada 100') && demographicPensionReply.includes('prestaciones de vejez y supervivencia') && demographicPensionReply.includes('deuda pública') && demographicPensionReply.includes('2,5 cotizantes por pensionista') && demographicPensionReply.includes('14,6 % del PIB') && demographicPensionReply.includes('13,0 % del PIB') && demographicPensionReply.includes('13,3 %') && demographicPensionReply.includes('-6,6 % del PIB') && demographicPensionReply.includes('123 % del PIB'), 'demography-pension fallback did not render precisely labelled context values');
...
assert(directPensionReply.includes('31,2') && directPensionReply.includes('205.009,77') && directPensionReply.includes('224.466,22') && directPensionReply.includes('100,7'), 'direct pension-finance response omitted reviewed fallback data');
