...
assert(demographicPensionReply.includes('29,5') && demographicPensionReply.includes('personas de 65 años o más por cada 100') && demographicPensionReply.includes('prestaciones de vejez y supervivencia') && demographicPensionReply.includes('deuda pública') && demographicPensionReply.includes('2,5 cotizantes por pensionista'), 'demography-pension fallback did not render concise labelled context values');
...
const directPensionReply = directPension?.blocks.find((block) => block.type === 'conversation_reply')?.text || '';
