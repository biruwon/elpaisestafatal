...
const europeanComparisonDefinitions = {
  ...
  part_time_employment_rate_europe: {
    label: 'Empleo a tiempo parcial',
    verb: 'registró una proporción de empleo a tiempo parcial del',
    replyLead: 'la proporción de empleo a tiempo parcial fue del',
    ...
    unit: '% de personas ocupadas de 15 a 64 años',
    replyUnit: '% de personas ocupadas de 15 a 64 años',
    differenceUnit: 'puntos porcentuales',
    method: 'La comparación usa la proporción de personas ocupadas de 15 a 64 años que declaran trabajar a tiempo parcial según Eurostat; no equivale a la proporción de empleos creados durante un periodo concreto.',
    caveat: 'Es una medida de la composición del empleo existente, no de salarios, estabilidad, voluntariedad, contratos nuevos o calidad completa del trabajo.',
  },
  temporary_employment_rate_europe: {
    label: 'Empleo temporal',
    verb: 'registró una proporción de empleo temporal del',
    replyLead: 'la proporción de empleo temporal fue del',
    differenceVerb: ['la proporción española fue más alta', 'la proporción española fue más baja', 'España y la Unión Europea registraron la misma proporción'],
    unit: '% de empleados de 15 a 64 años',
    replyUnit: '% de empleados de 15 a 64 años',
    differenceUnit: 'puntos porcentuales',
    method: 'La comparación usa la proporción de empleados de 15 a 64 años con contrato temporal según Eurostat; no equivale a todos los contratos firmados durante un año ni mide por sí sola la calidad del empleo.',
    caveat: 'La temporalidad describe la duración prevista del contrato, no directamente el salario, la voluntariedad, los derechos o la precariedad en sentido amplio.',
  },
