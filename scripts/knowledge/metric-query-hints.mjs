...
const metricHints = [
  ...
  { ids: ['imv_title_holders_by_nationality'], terms: ['ingreso minimo vital', 'ingreso minimo', 'imv', 'titulares del imv', 'beneficiarios del imv', 'ayudas del imv', 'renta minima vital'] },
