...
const metricHints = [
  ...
  { ids: ['foreign_born_population'], terms: ['nacidos fuera de espana', 'nacidos en el extranjero', 'poblacion nacida fuera', 'personas nacidas fuera', 'residentes nacieron fuera', 'poblacion inmigrante por pais de nacimiento', 'poblacion inmigrante segun su pais de nacimiento', 'inmigrantes segun pais de nacimiento'] },
