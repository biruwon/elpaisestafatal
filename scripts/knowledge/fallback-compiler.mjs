...
const semanticConceptAliases = [
  ...
  ['minor_accommodation_cost', ['mena', 'menas', 'menor migrante no acompañado', 'menores migrantes no acompañados', 'menor extranjero no acompañado', 'menores extranjeros no acompañados', 'acogida de menores migrantes', 'acogida de menores extranjeros']],
  ...
  ['public_housing_allocation', ['vivienda publica', 'vivienda protegida', 'vivienda social', 'lista de vivienda publica', 'adjudicacion de vivienda publica']],
  ['squatting_law', ['okupa', 'okupas', 'ocupacion ilegal de vivienda', 'ocupar una vivienda ajena', 'ocupa una vivienda ajena', 'vivienda ocupada sin permiso', 'persona que ocupa un inmueble', 'morada ajena', 'allanamiento de morada', 'desalojar una vivienda ocupada']],
  ...
  ['nuclear_phaseout', ['nuclear', 'nucleares', 'centrales nucleares', 'calendario nuclear', 'cierre nuclear', 'cierre de centrales nucleares', 'cierre de las centrales nucleares', 'cierre de las nucleares', 'cierre del parque nuclear', 'retirada de las nucleares', 'retirada escalonada de las nucleares', 'retirada de las centrales nucleares', 'desmantelamiento de centrales nucleares', 'fin de las centrales nucleares']],
  ['autonomous_competences', ['competencias autonomicas', 'competencias regionales', 'competencias de las comunidades autonomas', 'transferir competencias autonomicas', 'traspasar competencias autonomicas', 'suprimir las comunidades autonomas', 'eliminar las autonomias', 'estado de las autonomias', 'sistema autonomico']],
  ...
  ['amnesty_equality', ['amnistia', 'igualdad ante la ley', 'amnistia a los independentistas catalanes', 'amnistia del proces']],
  ['gender_law', ['violencia de genero', 'violencia machista', 'violencia contra la mujer', 'violencia de pareja', 'violencia contra la pareja', 'pareja o expareja mujer', 'ley de violencia de genero', 'discrimina a los hombres', 'presuncion de inocencia a hombres acusados']],
  ['juvenile_justice', ['ley del menor', 'impunidad para delitos graves']],
  ['sexual_consent_law', ['solo si es si', 'ley de libertad sexual', 'ley organica 10/2022', 'agresores sexuales', 'delitos sexuales', 'delitos contra la libertad sexual', 'rebajas de condena por la ley de libertad sexual']],
...
const claimTypeFor = (value) => {
  ...
  if (includesAny(text, ['cada vez', 'sube', 'baja', 'crece', 'creciendo', 'crecimiento', 'aumento', 'aumenta', 'aumentando', 'está aumentando', 'esta aumentando', 'ha aumentado', 'han aumentado', 'ha subido', 'han subido', 'ha bajado', 'han bajado', 'disminuye', 'dispara', 'disparado', 'se ha disparado', 'encarece', 'encarecido', 'encareciendo', 'encareciendose', 'cuesta mas', 'cuesta menos', 'mas caro', 'mas cara', 'mas caros', 'mas caras', 'mucho mas caro', 'mucho mas cara', 'mas costoso', 'mas costosa', 'no alcanza', 'no llega para', 'empeora', 'mejora', 'envejece', 'envejecemos', 'envejecimiento', 'no deja de', 'no dejan de', 'no para de', 'no paran de', 'sigue subiendo', 'sigue bajando', 'sigue creciendo', 'siguen creciendo', 'va en aumento', 'va en descenso', 'va al alza', 'va a la baja', 'va a peor', 'van a peor', 'va peor', 'van peor', 'va mejor', 'va a mejor', 'van mejor', 'record', 'historico', 'se esta volviendo'])) return 'trend';
