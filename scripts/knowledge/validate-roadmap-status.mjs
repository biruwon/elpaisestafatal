...
for (const model of report.model.candidates) if (!model.model || typeof model.passed !== 'boolean' || !Array.isArray(model.failureReasons)) errors.push('model candidate status is malformed');
