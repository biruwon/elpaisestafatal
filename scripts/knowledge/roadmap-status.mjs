...
const status = {
  ...
  gapDetail: { partialMetricIds, clusterClasses: gapClasses, domainContracts: (audit.domainGaps || []).map((gap) => ({ id: gap.id, domain: gap.domain, status: gap.status, missingFields: gap.missingFields || [], resolvedFields: gap.resolvedFields || [], irreducibleFields: gap.irreducibleFields || [], nextEvidence: gap.nextEvidence || null })) },
