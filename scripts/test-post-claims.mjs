...
const expectedStrong = new Set(['eviction-delay', 'unemployment', 'fixed-discontinuous', 'health-wait', 'unemployment-stats', 'fiscal', 'housing-price', 'imv', 'benefits', 'occupation-law', 'immigration-crime', 'residence-day', 'work-one-year', 'regularization', 'grandchildren', 'middle-class', 'residence-pending', 'no-expulsions', 'family-reunification', 'universal-health', 'fire-aircraft', 'immigration-open', 'fires-record', 'crime-stats', 'emergency-wait', 'ela', 'primary-sector', 'external', 'education', 'infrastructure', 'infrastructure-decay', 'industry', 'schools', 'fires-field', 'morocco-expulsion']);
