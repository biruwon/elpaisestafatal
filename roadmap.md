...
- The shipped refresh now has a validated default configuration covering twenty-eight live resources: BOE publications, INE CPI, and Eurostat macroeconomic, labour, population, migration, poverty, crime, housing, health, life-expectancy, fertility, ageing, older-population share, inequality, income, and public-finance series; refresh runs locally first from `.local/source-refresh.json` and falls back to the versioned configuration.
...
- A reproducible 76-case Spanish warehouse-routing benchmark now covers twenty-seven statistical metric families plus ten out-of-domain inputs. With the installed `bge-m3` baseline, hybrid retrieval reaches 64/66 top-1 metric routing versus 47/66 lexical, retains 66/66 recall@3, rejects 10/10 out-of-domain inputs, and produces no unsafe top match.
