...
- A reproducible 62-case Spanish warehouse-routing benchmark now covers twenty statistical metric families plus ten out-of-domain inputs. With the installed `bge-m3` baseline, hybrid retrieval reaches 50/52 top-1 metric routing versus 35/52 lexical, retains 52/52 recall@3, rejects 10/10 out-of-domain inputs, and produces no unsafe top match.
