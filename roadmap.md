...
- A reproducible 50-case Spanish warehouse-routing benchmark now covers all fourteen statistical metric families plus ten out-of-domain inputs. With the installed `bge-m3` baseline, hybrid retrieval reached 39/40 top-1 metric routing versus 24/40 lexical, retained 40/40 recall@3, rejected 10/10 out-of-domain inputs, and produced no unsafe top match.
