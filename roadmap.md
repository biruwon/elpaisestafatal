...
The two new comparison pages also exercise the reusable labelled comparison visual with units, period, evidence limit, and accessible value-table fallback. Broader reviewed chart coverage and reusable animated scenes remain future work.
