...
- A reproducible 58-case Spanish warehouse-routing benchmark now covers eighteen statistical metric families plus ten out-of-domain inputs. With the installed `bge-m3` baseline, hybrid retrieval reaches 46/48 top-1 metric routing versus 31/48 lexical, retains 48/48 recall@3, rejects 10/10 out-of-domain inputs, and produces no unsafe top match.
