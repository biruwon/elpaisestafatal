...
- 269 Markdown claim records exist; 91 are published.
- The 91 published claims now expose typed, evidence-linked core propositions; the browser index carries proposition IDs, the local resolver carries them into published answer plans, and the build validates the claim → proposition → evidence → source chain.
- All 91 published claim families now have structured conversation definitions covering everyday immigration, housing, employment, healthcare, tourism, prices, taxes, inequality, security, politics, youth, corruption, legal rules, demographic change, education, current government events, pensions, and Spain-versus-EU comparisons. They reuse the existing reviewed evidence warehouse and are exposed through the compact popular-entry set and topic filters.
...
- Direct comparison claims now use a reusable Spain-versus-EU visual with labelled values and units; the new health-spending family reuses the validated Eurostat warehouse metric without requiring a bespoke topic investigation.
...
- 97 proposition records, 86 evidence records, and 79 source records are currently linked; reviewed Spain-versus-EU comparison families now cover inflation, employment, public revenue, public expenditure, health spending, old-age/survivors benefits, current taxes on income and wealth, median disposable income, and GDP per inhabitant with explicit population definitions, periods, limitations, and proposition links.
...
This iteration adds two reviewed Spain-versus-EU comparison families—old-age/survivors benefits and current taxes on income and wealth—as static claim pages backed by the same warehouse metrics. They demonstrate the intended scale path: promote high-demand reusable evidence into concise pages without creating a bespoke investigation for every phrasing.
