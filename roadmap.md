...
- A reproducible 72-case Spanish warehouse-routing benchmark now covers twenty-five statistical metric families plus ten out-of-domain inputs. With the installed `bge-m3` baseline, hybrid retrieval reaches 60/62 top-1 metric routing versus 45/62 lexical, retains 62/62 recall@3, rejects 10/10 out-of-domain inputs, and produces no unsafe top match.
