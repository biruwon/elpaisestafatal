...
- A reproducible 80-case Spanish warehouse-routing benchmark now covers thirty statistical metric families plus ten out-of-domain inputs. With the installed `bge-m3` baseline, hybrid retrieval reaches 70/70 top-1 metric routing versus 51/70 lexical, retains 70/70 recall@3, rejects 10/10 out-of-domain inputs, and produces no unsafe top match; explicit metric hints are preserved when semantic neighbours disagree.
