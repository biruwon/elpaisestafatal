...
- `bge-m3`, `gemma3:4b`, and `qwen3-vl:8b` are installed on the development machine. After correcting and optimizing the real model path, the live regression remains 180/180 known matches and 120/120 unknown-safe results; at concurrency eight, known p95 is about 1.8 seconds and long-tail p95 about 2.6 seconds.
