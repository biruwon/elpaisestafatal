...
- 290 Markdown claim records exist; 115 are published Markdown families (the legacy affirmation catalogue now exposes 115 cards).
...
This iteration adds six reviewed Spain-versus-EU comparison families—old-age/survivors benefits, current taxes on income and wealth, total social-protection benefits per inhabitant, public deficit, income inequality, and public debt—as static claim pages backed by the same warehouse metrics. It also adds the reviewed youth-unemployment comparison family, extending the existing youth level and trend coverage into a same-period international comparison. They demonstrate the intended scale path: promote high-demand reusable evidence into concise pages without creating a bespoke investigation for every phrasing.
