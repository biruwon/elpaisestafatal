...
- The shipped refresh now has a validated default configuration covering twenty-four live resources: BOE publications, INE CPI, and Eurostat macroeconomic, labour, population, migration, poverty, crime, housing, health, inequality, income, and public-finance series; refresh runs locally first from `.local/source-refresh.json` and falls back to the versioned configuration.
...
- A reproducible 68-case Spanish warehouse-routing benchmark now covers twenty-three statistical metric families plus ten out-of-domain inputs. With the installed `bge-m3` baseline, hybrid retrieval reaches 56/58 top-1 metric routing versus 41/58 lexical, retains 58/58 recall@3, rejects 10/10 out-of-domain inputs, and produces no unsafe top match.
